...
public class GenDotFile {
	...
	static class FunctionListener extends GroupoidBaseListener {
		Graph graph = new Graph();
		String currentFunctionName = null;

		public void enterFunctionDecl(GroupoidParser.GroupContext ctx) {
			currentFunctionName = ctx.ID().getText();
			graph.nodes.add(currentFunctionName);
		}

		public void exitCall(GroupoidParser.MemberContext ctx) {
	...
	public static void main(String[] args) throws Exception {
		...
		GroupoidParser parser = new GroupoidParser(tokens);
